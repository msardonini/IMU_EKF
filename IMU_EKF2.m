function [P,q]=IMU_EKF2(P,q,Cov_info,omega,accel,mag,dt,ini,use_mag)
...
Bk=single(dt/2*[-q(2),-q(3),-q(4);q(1),-q(4),q(3);q(4),q(1),-q(2);-q(3),q(2),q(1)]);
q=q+Bk*omega;

%Propagate Covariance
Q=single(Cov_info(1)*eye(3));
P=P+Bk*Q*Bk';
